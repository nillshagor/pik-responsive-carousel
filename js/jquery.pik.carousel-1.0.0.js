...
PIK.ImageLoader = function(a) {
    this.subscribers = [];
    this.img = a;
    this.fired = !1
};
PIK.ImageLoader.prototype = {
...
PIK.CarouselItem.prototype = {
    ...
    load: function() {
        var a = this;
        if (!this.loaded) {
            var b = new PIK.ImageLoader(this.image);
    ...
    onImageLoaded: function() {
        ...
        this.carousel.settings.reflectionVisible && (this.reflection = PIK.CarouselItem.createReflection(this.imageElement,
    ...
    update: function() {
        var a = this.carousel.settings;
        if (PIK.Utils.has2dTransformationSupport()) a =
            "translate(" + this.x + "px, " + this.y + "px) scale(" + this.scale + ")", PIK.Utils.has3dTransformationSupport() && (a += " translateZ(0)"), this.element.css(PIK.Utils.getPrefixedProperty("transform"), a), this.element.css("opacity", this.alpha);
        else {
            ...
            a.reflectionVisible && !PIK.Utils.hasCanvasSupport() ? (c.opacity = this.alpha, this.reflection && this.reflection.css({
                width: b.width,
                height: b.height,
                filter: PIK.CarouselItem.getAlphaFilterStatement(a.reflectionAlpha, a.reflectionSize, a.itemHeight)
...
PIK.CarouselItem.createReflection = function(a, b, c) {
    var d = a.width(),
        g = a.height(),
        e = null;
    PIK.Utils.hasCanvasSupport() ? (e = $("<canvas>"), ctx = e.get(0).getContext("2d"), e.attr({
        width: d,
        height: b
        ...
        0, d, b)) : (e = $("<img>"), e.attr({
        src: a.get(0).src
    }), e.css("filter", PIK.CarouselItem.getAlphaFilterStatement(c, b, g)));
    return e
};
PIK.CarouselItem.getAlphaFilterStatement = function(a, b, c) {
...
PIK.Container = function(a, b) {
    this.element = a;
    this.carousel = b;
    this.x = 0
};
PIK.Container.prototype = {
    setX: function(a, b) {
        this.x = a;
        this.update(b)
    },
    ...
    update: function(a) {
        ...
        }), PIK.Utils.hasTransitionSupport() ? (this.element.css(PIK.Utils.getPrefixedProperty("transition"), "left " + a + "s ease-out"), this.element.css("left", this.x)) : this.element.stop().animate({
            left: this.x
        }, 1E3 * a, function() {
            b.carousel.onSelectionAnimationEnd()
        })) : (PIK.Utils.hasTransitionSupport() && this.element.css(PIK.Utils.getPrefixedProperty("transition"), ""), this.element.stop().css({
            left: this.x
        }))
    }
};
PIK.Carousel = function(a, b) {
    this.settings = {
        itemWidth: 300,
        itemHeight: 450,
        distance: 15,
...
PIK.Carousel.prototype = {
    ...
    initDOM: function() {
        ...
        this.dom.wrapper = this.dom.carousel.children(".pik-carousel-wrapper");
        this.dom.container = this.dom.wrapper.children(".pik-carousel-container");
    ...
    initConfigParams: function() {
        ...
        PIK.Utils.has2dTransformationSupport() && this.dom.items.css(PIK.Utils.getPrefixedProperty("transformOrigin"), "center " + Math.round(a.itemHeight / 2) + "px")
    },
    initEvents: function() {
        PIK.Utils.hasTouchSupport() ?
    ...
    initContainer: function() {
        var a = this,
            b = 0;
        this.container = new PIK.Container(this.dom.container, this);
        this.dom.items.each(function(c) {
            c = new PIK.CarouselItem($(this), a);
        ...
        PIK.Utils.hasTouchSupport() || this.dom.carousel.hover(function(b) {
            a.mouseOver = !0;
            a.updateCursor()
        }, function(b) {
            a.mouseOver = !1;
    ...
    startAutoSlideshow: function() {
        var a =
            this,
            b = this.settings;
        this.timer || (this.timer = new PIK.Timer(1E3 * b.autoSlideshowDelay), this.timer.subscribe(function(c) {
    ...
    updateCursor: function() {
        this.dragging ? PIK.Utils.setCursor("closedhand") : this.mouseOver ? PIK.Utils.setCursor("openhand") : PIK.Utils.setCursor("auto")
    },
    ...
    onStart: function(a) {
        function b(a) {
            var b = a.originalEvent,
                c = PIK.Utils.hasTouchSupport() ? b.touches[0].clientX : a.clientX,
                g = PIK.Utils.hasTouchSupport() ? b.touches[0].clientY : a.clientY,
                r = (c - startX) / 2 + n;
            m = f - c;
            f = c;
            if (PIK.Utils.hasTouchSupport()) {
        ...
        function c(a) {
            var f = a.originalEvent,
                e = PIK.Utils.hasTouchSupport() ? f.changedTouches[0].clientX : a.clientX;
            a = PIK.Utils.hasTouchSupport() ? f.changedTouches[0].clientY : a.clientY;
        ...
        if ("A" != a.target.nodeName) {
            var d = this,
                g = this.settings,
                e = a.originalEvent,
                f = startX = PIK.Utils.hasTouchSupport() ? e.targetTouches[0].clientX : a.clientX,
                h = PIK.Utils.hasTouchSupport() ? e.targetTouches[0].clientY : a.clientY,
            ...
            PIK.Utils.hasTouchSupport() ? 1 < e.touches.length && (q = !0) : a.preventDefault()
        }
    },
...
(function(a) {
    a.fn.carousel = function(b) {
        ...
        this.each(function() {
            var d = a(this);
            d.data("pik-carousel") || d.data("pik-carousel", new PIK.Carousel(d, b));
            c.push(d.data("pik-carousel"))
        });
